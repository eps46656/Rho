#ifndef RHO__define_guard__Container__PoolList_cuh
#define RHO__define_guard__Container__PoolList_cuh

#include "BidirectionalNode.cuh"

#define RHO__throw__local(desc) RHO__throw(cntr::PoolList, __func__, desc)
...
#///////////////////////////////////////////////////////////////////////////////
	...
	RHO__cuda PoolList(): size_(0), end_(&this->node_) {}

	RHO__cuda PoolList(const PoolList<T>& list):
		size_(list.size_), end_(&this->node_) {
	...
	RHO__cuda PoolList(PoolList<T>&& list): size_(list.size_), end_(list.end_) {
		list.size_ = 0;
